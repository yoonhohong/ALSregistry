        ...
        column(3,
               wellPanel(
                 ...
                 dateRangeInput("range_date_enrollment", "Enrollment", 
                                start = date_update_registry - as.difftime(14, units = "days"),
                                end = date_update_registry), 
                 dateRangeInput("range_date_fu_latest", "Latest fu visit", 
                                start = date_update_registry - as.difftime(14, units = "days"),
                                end = date_update_registry), 
                 checkboxGroupInput("filter", "Filters", 
                                    choices = c("Diagnosis" = "dx", 
                                                "Date of enrollment" = "date_enrollment", 
                                                "Date of latest fu visit" = "date_visit"), 
                                    selected = c("dx", "date_visit")),
                 br(),
                 p(class = "text-center", 
